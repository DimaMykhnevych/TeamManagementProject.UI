...
export class IdentityService {
  ...
  public getUser() {
    return this.http.get(environment.apiRoutes.identity.getUser, { withCredentials: true })
  }

  public getUsers() {
    return this.http.get(environment.apiRoutes.identity.getUsers, { withCredentials: true })
  }
